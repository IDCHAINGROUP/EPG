...
This document provides guidelines for internationalization of the encocoinplus software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to encocoinplus network</source>
        <translation>
            <numerusform>%n active connection to encocoinplus network</numerusform>
            <numerusform>%n active connections to encocoinplus network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `encocoinplus_en.ts` remains unchanged.
