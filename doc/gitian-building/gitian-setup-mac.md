...
The build script we'll be using is contained in the encocoinplus github repository ([contrib/gitian-build.py](https://github.com/Encocoin/encocoinplus/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the encocoinplus repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Encocoin/encocoinplus/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, encocoinplus-detached-sigs, and encocoinplus GitHub repos.
