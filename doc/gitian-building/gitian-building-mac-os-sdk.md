...
The script [extract-osx-sdk.sh](https://github.com/Encocoin/encocoinplus/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
encocoinplus/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Encocoin/encocoinplus/blob/master/doc/README_osx.md) for troubleshooting tips.
