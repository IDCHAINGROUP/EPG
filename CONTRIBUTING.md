Contributing to encocoinplus
============================

The encocoinplus project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Encocoin/encocoinplus/blob/master/doc/translation_process.md)
...
The following applies to code changes to the encocoinplus project, and is not to be
confused with overall encocoinplus Network Protocol consensus changes.

Whether a pull request is merged into encocoinplus rests with the project merge
...
Patches that change encocoinplus consensus rules are considerably more involved than
...
Where a patchset proposes to change the encocoinplus consensus, it must have been
...
The project leader is the release manager for each encocoinplus release.
