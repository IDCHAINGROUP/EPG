...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256S("00000571ef34869f811e36709bf89ef52fa674178e0142e50b791ed7c1d3e3db"))/*
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1644613888, 152051, "Ukraine tensions: Russia invasion could begin any day, US warns");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256("00000571ef34869f811e36709bf89ef52fa674178e0142e50b791ed7c1d3e3db"));
        assert(genesis.hashMerkleRoot == uint256("8aa7403b168f36ff16c020126f1ec1e12378381034f9c1d70e14175f4732cbc7"));
 
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // encocoinplus starting difficulty is 1 / 2^12
        ...
        consensus.devAddress = "53ZWPWG1zfoGb1QP8Y4o57zfYYNj3JWHZA";
				
        // spork key
        consensus.strSporkPubKey = "04410cf61ab8bdf2f3bb39c361312bb60f549135232b00085736fa2905f73e60216c32edce58a1916c2af49a5665d69a875217a39d30bd20855e84eaf587e92e17";

        // height-based activations
        consensus.height_last_PoW = 2000;
        consensus.height_start_BIP65 = 2003;
        consensus.height_start_MessSignaturesV2 = 2030;  // height_start_TimeProtoV2
        consensus.height_start_StakeModifierNewSelection = 1;
        consensus.height_start_StakeModifierV2 = 2001;
        consensus.height_start_TimeProtoV2 = 2030;
        ...
        vSeeds.push_back(CDNSSeedData("104.156.250.147", "104.156.250.147")); 
        vSeeds.push_back(CDNSSeedData("207.246.126.63", "207.246.126.63"));
        vSeeds.push_back(CDNSSeedData("104.238.129.92", "104.238.129.92"));
        vSeeds.push_back(CDNSSeedData("108.61.23.205", "108.61.23.205"));

        // Note that of those with the service bits flag, most only support a subset of possible options

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 10);		// EPG addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);		// EPG script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);	// EPG staking addresses start with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // EPG BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // EPG BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
...
*/
	...
	//assert(consensus.hashGenesisBlock == uint256S("0x001"));
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 14;   // encocoinplus starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        consensus.nBudgetCycleBlocks = 43200;       // approx. 1 every 30 days
        consensus.nBudgetFeeConfirmations = 6;      // Number of confirmations for the finalization fee
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 38);  // EPG testnet addresses start with 'G'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 4);   // EPG script addresses start with '3'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 80); // EPG staking addresses start with 'Z'
