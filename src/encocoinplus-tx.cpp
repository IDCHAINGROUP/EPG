...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("encocoinplus encocoinplus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  encocoinplus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded encocoinplus transaction") + "\n" +
                               "  encocoinplus-tx [options] -create [commands]   " + _("Create hex-encoded encocoinplus transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded encocoinplus transaction
