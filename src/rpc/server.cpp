...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop EncocoinPlus Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "EncocoinPlus Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* encocoinplus features */
        {"encocoinplus", "listmasternodes", &listmasternodes, true, true, false},
        {"encocoinplus", "getmasternodecount", &getmasternodecount, true, true, false},
        {"encocoinplus", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"encocoinplus", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"encocoinplus", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"encocoinplus", "masternodecurrent", &masternodecurrent, true, true, false},
        {"encocoinplus", "masternodedebug", &masternodedebug, true, true, false},
        {"encocoinplus", "startmasternode", &startmasternode, true, true, false},
        {"encocoinplus", "createmasternodekey", &createmasternodekey, true, true, false},
        {"encocoinplus", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"encocoinplus", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"encocoinplus", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"encocoinplus", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"encocoinplus", "getmasternodescores", &getmasternodescores, true, true, false},
        {"encocoinplus", "preparebudget", &preparebudget, true, true, false},
        {"encocoinplus", "submitbudget", &submitbudget, true, true, false},
        {"encocoinplus", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"encocoinplus", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"encocoinplus", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"encocoinplus", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"encocoinplus", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"encocoinplus", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"encocoinplus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"encocoinplus", "checkbudgets", &checkbudgets, true, true, false},
        {"encocoinplus", "mnsync", &mnsync, true, true, false},
        {"encocoinplus", "spork", &spork, true, true, false},
...
{
    return "> encocoinplus-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29001/\n";
}
