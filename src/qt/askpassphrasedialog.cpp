...
#include "qt/encocoinplus/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            encocoinplusGUI* window = static_cast<encocoinplusGUI*>(parentWidget());
...
{
    encocoinplusGUI* gui = static_cast<encocoinplusGUI*>(parentWidget());
...
{
    hide();
    static_cast<encocoinplusGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("EncocoinPlus Coin will close now to finish the encryption process. "
