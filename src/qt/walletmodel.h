...
#ifndef encocoinplus_QT_WALLETMODEL_H
#define encocoinplus_QT_WALLETMODEL_H
...
/** Interface to encocoinplus wallet from Qt view code. */
...
#endif // encocoinplus_QT_WALLETMODEL_H
