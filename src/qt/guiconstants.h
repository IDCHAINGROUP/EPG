...
/* encocoinplus GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EncocoinPlus Coin"
#define QAPP_ORG_DOMAIN "encocoin.net"
#define QAPP_APP_NAME_DEFAULT "EncocoinPlus Coin-Qt"
#define QAPP_APP_NAME_TESTNET "EncocoinPlus Coin-Qt-testnet"
