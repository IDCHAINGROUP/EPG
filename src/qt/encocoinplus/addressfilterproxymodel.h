...
#ifndef encocoinplus_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define encocoinplus_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //encocoinplus_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
