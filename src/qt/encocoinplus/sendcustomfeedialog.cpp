...
#include "qt/encocoinplus/sendcustomfeedialog.h"
#include "qt/encocoinplus/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(encocoinplusGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &encocoinplusGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
