...
#include "qt/encocoinplus/forms/ui_topbar.h"
#include "qt/encocoinplus/lockunlock.h"
#include "qt/encocoinplus/qtutils.h"
#include "qt/encocoinplus/receivedialog.h"
...
TopBar::TopBar(encocoinplusGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("encocoinplus")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // EPG Total
    QString totalEPG = GUIUtil::formatBalance(balance, nDisplayUnit);
