...
#include "qt/encocoinplus/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(encocoinplusGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("encocoinplus_tx_csv_export(*.csv)") : tr("encocoinplus_addresses_csv_export(*.csv)"),
                                        nullptr);
