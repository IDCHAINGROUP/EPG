...
#include "qt/encocoinplus/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(encocoinplusGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &encocoinplusGUI::openFAQ);
