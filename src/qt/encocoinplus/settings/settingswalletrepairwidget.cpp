...
#include "qt/encocoinplus/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/encocoinplus/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(encocoinplusGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to encocoinplusGUI::handleRestart()
