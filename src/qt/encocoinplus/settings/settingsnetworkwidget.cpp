...
#include "qt/encocoinplus/settings/settingsnetworkwidget.h"
#include "qt/encocoinplus/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/encocoinplus/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(encocoinplusGUI* _window, QWidget *parent) :
