...
#include "qt/encocoinplus/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/encocoinplus/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(encocoinplusGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableEPG,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableEPG,
    ...
    connect(ui->pushButton_UnspendableEPG, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableEPG);});
    ...
    if (parent)
        connect(parent, &encocoinplusGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
