...
#include "qt/encocoinplus/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/encocoinplus/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(encocoinplusGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the EncocoinPlus Coin RPC console.") + "<br>" +
