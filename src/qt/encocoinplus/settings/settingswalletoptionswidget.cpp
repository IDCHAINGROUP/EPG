...
#include "qt/encocoinplus/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/encocoinplus/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(encocoinplusGUI* _window, QWidget *parent) :
