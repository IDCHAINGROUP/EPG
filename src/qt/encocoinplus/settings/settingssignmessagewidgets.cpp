...
#include "qt/encocoinplus/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(encocoinplusGUI* _window, QWidget *parent) :
