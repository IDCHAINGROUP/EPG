...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, encocoinplusGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, encocoinplusGUI* gui, double posX = 3);
