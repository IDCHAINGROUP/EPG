...
#include "qt/encocoinplus/forms/ui_addresseswidget.h"
#include "qt/encocoinplus/addresslabelrow.h"
#include "qt/encocoinplus/addnewaddressdialog.h"
#include "qt/encocoinplus/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(encocoinplusGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination encocoinplusAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(encocoinplusAdd, label.toUtf8().constData(),
