...
#include "qt/encocoinplus/forms/ui_masternodeswidget.h"

#include "qt/encocoinplus/qtutils.h"
#include "qt/encocoinplus/mnrow.h"
#include "qt/encocoinplus/mninfodialog.h"
#include "qt/encocoinplus/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(encocoinplusGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral(chainActive.Height()) * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 EPG required.").arg(GetMNCollateral(chainActive.Height())));
        return;
    }
    showHideOp(true);
