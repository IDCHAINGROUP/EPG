...
#include "qt/encocoinplus/forms/ui_send.h"
#include "qt/encocoinplus/addnewcontactdialog.h"
#include "qt/encocoinplus/qtutils.h"
#include "qt/encocoinplus/sendchangeaddressdialog.h"
#include "qt/encocoinplus/optionbutton.h"
#include "qt/encocoinplus/sendconfirmdialog.h"
#include "qt/encocoinplus/myaddressrow.h"
#include "qt/encocoinplus/guitransactionsutils.h"
...
SendWidget::SendWidget(encocoinplusGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-encocoinplus");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination encocoinplusAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(encocoinplusAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(encocoinplusAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
