...
#include "qt/encocoinplus/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/encocoinplus/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ...
        ui->lineEditPort->setText("129001");
    } else {
        ui->lineEditPort->setText("29000");
    }
...
bool MasterNodeWizardDialog::createMN()
{
    ...
    if (!walletModel->getMNCollateralCandidate(collateralOut)) {
        ...
        SendCoinsRecipient sendCoinsRecipient(
                ...
                GetMNCollateral(chainActive.Height()) * COIN,
                "");
