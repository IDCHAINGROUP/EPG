...
#include <QWidget>
#include <QString>
#include "qt/encocoinplus/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(encocoinplusGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    encocoinplusGUI* getWindow() { return this->window; }
...
protected:
    encocoinplusGUI* window = nullptr;
