...
/** Utility functions used by the encocoinplus Qt UI.
 */
namespace GUIUtil
{
...
// Render encocoinplus addresses in monospace font
...
// Parse "encocoinplus:" URI into recipient object, return true on successful parsing
