...
static const CAmount DEFAULT_MIN_STAKE_SPLIT_THRESHOLD = 300 * COIN;
...
enum WalletFeature {
    ...
    FEATURE_PRE_encocoinplus = 61000, // inherited version..
...
public:
    ...
    /// Get 1000 EPG output and keys which can be used for the Masternode
