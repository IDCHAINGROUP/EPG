...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock)
{
    ...
    /* current difficulty formula, encocoinplus - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
...
{
    // Blocks from PoW phase are now all secured by checkpoints in chainparams
    return true;
}
